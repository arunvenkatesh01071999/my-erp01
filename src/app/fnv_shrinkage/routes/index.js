...
module.exports = async fastify => {
  ...
  fastify.route({
    method: "PUT",
    url: "/fnv/shrinkage/:shrinkage_id",
    preHandler: fastify.authenticate,
  ...
  fastify.route({
    method: "GET",
    url: "/fnv/shrinkage/:page_size/:current_page",
    preHandler: fastify.authenticate,
  ...
  fastify.route({
    method: "GET",
    url: "/fnv/shrinkage/info/:shrinkage_id",
    preHandler: fastify.authenticate,
