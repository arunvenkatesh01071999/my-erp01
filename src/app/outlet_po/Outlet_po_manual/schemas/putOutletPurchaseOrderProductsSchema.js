...
const putOutletPurchaseOrderProductsSchema = {
  tags: ["Purchase Order Update"],
  summary: "API to update purchase orders",
  ...
  body: {
    ...
    properties: {
      podate: {
        type: "string",
        format: "date",
        errorMessage: "podate must be a valid date in YYYY-MM-DD format"
      },
      supplier_id: {
        type: "integer",
      ...
      delivery_date: {
        type: "string",
        format: "date",
        errorMessage: "delivery_date must be a valid date in YYYY-MM-DD format"
      },
      purchase_order_details: {
        type: "array",
        minItems: 1,
        ...
        items: {
          ...
          properties: {
            ...
            balance: {
              type: "number",
              errorMessage: "balance must be an number"
            },
            ...
            loose_qty: {
              type: "integer",
              errorMessage: "loose qty must be an integer"
            },
            received_qty: {
              type: "integer",
            ...
            cess_amount: {
              type: "number",
              errorMessage: "cess_amount must be a number"
            },
            case_qty: {
              type: "integer",
              errorMessage: "case_qty must be an integer"
            }
          }
        }
      }
...
module.exports = putOutletPurchaseOrderProductsSchema;
