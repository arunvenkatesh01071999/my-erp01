...
const getWastageInfoSchema = {
    tags: ["FV Planning Inward Info"],
    summary: "This API is to get FV Planning Inward Info",
                ...
                wastage_details: {
                    ...
                    items: {
                        ...
                        properties: {
                            ...
                            item_gst: { type: "number", errorMessage: "item_gst must be an number" },
                            item_cess: { type: "number", errorMessage: "item_cess must be an number" }
                        }
                    }
                },
