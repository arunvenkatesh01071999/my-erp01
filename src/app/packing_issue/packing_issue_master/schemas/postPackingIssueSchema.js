...
const postPackingIssueSchema = {
  tags: ["PackingIssue"],
  summary: "This API is to post a Packing Issue",
  headers: { $ref: "request-headers#" },
  body: {
    type: "object",
    required: ["docdate", "wh_id", "total_items", "total_qty", "packing_details", "amount"],
    properties: {
      docdate: { type: "string" },
      wh_id: { type: "integer" },
      ...
      packing_details: {
        ...
        items: {
          type: "object",
          required: ["docdate", "prod_id", "total_qty",
            "cat_id", "sub_cat_id", "head_id", "type_design_id", "uom_id", "barcode", "pur_rate",
...
module.exports = postPackingIssueSchema;
