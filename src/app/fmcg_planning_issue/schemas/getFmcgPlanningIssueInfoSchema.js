...
const getFmcgPlanningIssueInfoSchema = {
    tags: ["FMCG Planning Issue Info"],
    summary: "This API is to get FMCG Planning Issue Info",
...
module.exports = getFmcgPlanningIssueInfoSchema;
