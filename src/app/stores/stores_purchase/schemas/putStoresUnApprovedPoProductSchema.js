...
const putUnApprovedPoProductSchema = {
  tags: ["Purchase Order Update"],
  summary: "API to update unapproved purchase orders",
  ...
  body: {
    ...
    properties: {
      un_approved_pono: {
        type: "array",
        description: "List of purchase orders to update",
        items: {
          type: "object",
...
module.exports = putUnApprovedPoProductSchema;
