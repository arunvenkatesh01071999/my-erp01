    ...
    response: {
        200: {
            ...
            properties: {
                ...
                w_com_id: { type: "integer", errorMessage: "w_com_id must be an integer" },
                ...
                wastage_details: {
                    ...
                    items: {
                        ...
                        properties: {
                            ...
                            wd_com_id: { type: "integer", errorMessage: "wd_com_id must be an integer" },
                            ...
                            wd_whstock: { type: "number", errorMessage: "wd_wh_stock must be a number" },
                            wd_dne: { type: "integer", errorMessage: "wd_dne must be an integer" }
                        }
                    }
                }
            }
...
module.exports = getWastageInfoSchema;
