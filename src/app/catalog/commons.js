...
const WAREHOUSE_CUSTOMER_MAPPING = {
  NAME: "warehouse_customer_mapping",
  COLUMNS: {
    ID: "id",
...
const WAREHOUSE_PRODUCTS_MAPPING = {
  NAME: "warehouse_products_mapping",
  COLUMNS: {
    ID: "id",
    WAREHOUSE_ID: "warehouse_id",
...
const COMPANY_PRODUCTS_MAPPING = {
  NAME: "company_products_mapping",
  COLUMNS: {
    ID: "id",
    COMPANY_ID: "company_id",
    PRODUCT_ID: "product_id",
...
const CUSTOMER_PRODUCTS_MAPPING = {
  NAME: "customer_products_mapping",
  COLUMNS: {
    ID: "id",
    CUSTOMER_ID: "customer_id",
    PRODUCT_ID: "product_id",
...
const WAREHOUSE_OUTLET_MAPPING = {
  NAME: "warehouse_outlet_mapping",
  COLUMNS: {
    ID: "id",
    WAREHOUSE_ID: "warehouse_id",
    OUTLET_ID: "outlet_id",
...
module.exports = {
  ...
  ITEM_LOGS,
  CUSTOMER,
  CUSTOMER_PRODUCTS_MAPPING,
  COMPANY_PRODUCTS_MAPPING,
  WAREHOUSE_CUSTOMER_MAPPING,
  WAREHOUSE_PRODUCTS_MAPPING,
