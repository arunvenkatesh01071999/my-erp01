    ...
    body: {
        ...
        properties: {
            ...
            shrinkage_details: {
                type: "array",
                minItems: 1,
                errorMessage: "Shrinkage_details must be a valid and non-empty array",
                items: {
                    type: "object",
                    required: [
                        ...
                        "wd_prate", "wd_pamt", "wd_reason_id"
                    ],
                    properties: {
                        wd_id: { type: "string", errorMessage: "wd_id must be an string" },
...
module.exports = postShrinkageSchema;
